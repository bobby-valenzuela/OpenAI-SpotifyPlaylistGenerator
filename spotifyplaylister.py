...
def main():
    ...
    load_dotenv(args.envfile)   # Load env values as environment variables
...
def get_playlist(prompt, count=8):
    ...
    messages = [
        ...
        Your should only return a JSON array, where each element follows this format: {"song": <song_title>, "artist": <artist_name>}
        """
        },
...
def add_songs_to_spotify(playlist_prompt, playlist):
    ...
    assert current_user is not None, "Spotify User Not foune. Exiting Program"
